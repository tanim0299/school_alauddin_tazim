...
<!-- Start app main Content -->
        <div class="main-content">
            <section class="section">
                ...
                <div class="links">
                    <a href="view_prospects.php" class="btn btn-info">View Prospects</a>
                </div>
                <div class="form-section">
                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        if(isset($_POST['save']))
                        {
                            ...
                            $sql = $db->link->query("UPDATE `prospects` SET `date`='$date',`title`='$title',`description`='$description' WHERE `id`='$id' ");
                        }
                            
                    }

                        $sql = $db->link->query("SELECT * FROM `prospects` WHERE `id`='$id'");
