        ...
        <div class="main-content">
            <section class="section">
                <div class="form-header">
                    <h4>Edit Transfer Procedure</h4>
                </div>
                <div class="links">
                    <a href="view_transfer_procedure.php" class="btn btn-info">View Transfer Procedure</a>
                </div>
                <div class="form-section">
                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        if(isset($_POST['save']))
                        {
                            ...
                            $sql = $db->link->query("UPDATE `transfer_procedure` SET `date`='$date',`title`='$title',`description`='$description' WHERE `id`='$id' ");
                        }
