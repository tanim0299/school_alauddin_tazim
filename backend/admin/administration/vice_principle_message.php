        ...
        <div class="main-content">
            <section class="section">
                <div class="form-header">
                    <h4>Vice Principle Message</h4>
                </div>
                <div class="form-section">
                   <?php
                   $data = $db->link->query("SELECT * FROM `vice_principle_message` WHERE `id`=1");
                   if($data)
                   {
                   ...
                   if(isset($_POST['save']))
                   {
                        ...
                        $update = $db->link->query("UPDATE `vice_principle_message` SET `name`='$name',`title`='$title',`description`='$description' WHERE `id`=1");
                        ...
                        if($update)
                        {
                            ...
                            if($file)
                            {
                                $path = '../../asset/img/vice_principle_message/'.$showdata['image'];
                            ...
                            if($file)
                            {
                                ...
                                $image_path = '../../asset/img/vice_principle_message/'.$image_name;

                                move_uploaded_file($_FILES['image']['tmp_name'],$image_path);

                                $db->link->query("UPDATE `vice_principle_message` SET `image`='$image_name' WHERE `id`=1");
                   ...
                   ?>
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-single-box">
                            ...
                            {
                            ?>
                            <img src="../../asset/img/vice_principle_message/<?php print $showdata['image']; ?>" class="img-fluid" height="70px;" width="90px">
                            <?php
                            }
                            ?>
                        </div>
