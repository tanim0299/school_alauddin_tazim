...
<div class="main-content">
     <section class="section">
              ...
              if (isset($_POST['save'])) 
              {
                 ...
                 $sql=$db->link->query("UPDATE `mission_vision` SET `description`='$description' WHERE `id`=1");
                  if($sql)
                                {
              ...
              $sql_select=$db->link->query("SELECT * FROM `mission_vision` WHERE `id`=1");
              if($sql_select)
              {
