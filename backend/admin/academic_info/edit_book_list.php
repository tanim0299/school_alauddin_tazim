...
<!-- Start app main Content -->
        <div class="main-content">
            <section class="section">
                ...
                <div class="links">
                    <a href="view_book_list.php" class="btn btn-info">View Book List</a>
                </div>
                <div class="form-section">
                    ...
                    if (isset($_POST['save'])) 
                      {
                        ...
                        $db->update('book_list',['date'=>$date,'class_id'=>$class,'title'=>$title],"id='$id'");
                        ...
                        if($db)
                        {
                            ...
                            if($file)
                            { 
                                $pathImage = $db->link->query("SELECT `image` FROM `book_list` WHERE `id`='$id' ");
                                $fetch_image = $pathImage->fetch_assoc();

                                $path = '../../asset/img/book_list/'.$fetch_image['image'];
                            ...
                            if($file)
                            {
                                ...
                                $path = '../../asset/img/book_list/'.$image_name;

                                move_uploaded_file($_FILES['image']['tmp_name'],$path);
                                $db->link->query("UPDATE `book_list` SET `image`='$image_name' WHERE `id`='$id'");
                        ...
                        $sql = $db->link->query("SELECT * FROM `book_list` WHERE `id`='$id'");
                    ...
                    <div class="form-body-main">
                        ...
                        <div class="form-group row">
                            ...
                            <img src="../../asset/img/book_list/<?php echo $showdata['image']; ?>" class="img-fluid" alt="" height="80px" width="80px">
                        </div>
