        ...
        <div class="main-content">
            <section class="section">
                <div class="form-header">
                    <h4>Edit Online Class Routine</h4>
                </div>
                <div class="links">
                    <a href="view_online_class_routine.php" class="btn btn-info">View Online Class Routine</a>
                </div>
                <div class="form-section">
                    ...
                    if (isset($_POST['save'])) 
                      {
                        ...
                        $db->update('online_class_routine',['date'=>$date,'class_id'=>$class,'title'=>$title],"id='$id'");
                        ...
                        if($db)
                        {
                            ...
                            if($file)
                            {
                                ...
                                $path = '../../asset/img/online_class_routine/'.$image_name;

                                move_uploaded_file($_FILES['image']['tmp_name'],$path);
                                $db->link->query("UPDATE `online_class_routine` SET `image`='$image_name' WHERE `id`='$id'");
                    ...
                    <div class="form-body-main">
                        ...
                        <div class="form-group row">
                            ...
                            <img src="../../asset/img/online_class_routine/<?php echo $showdata['image']; ?>" class="img-fluid" alt="" height="80px" width="80px">
                        </div>
