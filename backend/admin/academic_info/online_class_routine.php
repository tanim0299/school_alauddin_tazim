        ...
        <div class="main-content">
            <section class="section">
                ...
                if(isset($_POST['save']))
                {
                    ...
                    $db->insert('online_class_routine',['date'=>$date,'class_id'=>$class,'title'=>$title]);
                    ...
                    if($file)
                    {
                        ...
                        $image_path = '../../asset/img/online_class_routine/'.$image_name;

                        move_uploaded_file($_FILES['image']['tmp_name'],$image_path);

                        $db->update('online_class_routine',['image'=>$image_name],"id='$id'");
