...
<!-- Start app main Content -->
        <div class="main-content">
            <section class="section">
                ...
                <div class="links">
                    <a href="view_lesson_plan.php" class="btn btn-info">View Lesson Plan</a>
                </div>
                <div class="form-section">
                    ...
                    if (isset($_POST['save'])) 
                      {
                        ...
                        $db->update('lesson_plan',['date'=>$date,'class_id'=>$class,'title'=>$title],"id='$id'");
                        ...
                        if($db)
                        {
                            ...
                            if($file)
                            {
                                ...
                                $path = '../../asset/img/lesson_plan/'.$image_name;

                                move_uploaded_file($_FILES['image']['tmp_name'],$path);
                                $db->link->query("UPDATE `lesson_plan` SET `image`='$image_name' WHERE `id`='$id'");
                        ...
                        $sql = $db->link->query("SELECT * FROM `lesson_plan` WHERE `id`='$id'");
                    ...
                    <div class="form-body-main">
                        ...
                        <div class="form-group row">
                            ...
                            <img src="../../asset/img/lesson_plan/<?php echo $showdata['image']; ?>" class="img-fluid" alt="" height="80px" width="80px">
                        </div>
