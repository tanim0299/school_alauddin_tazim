                ...
                <div class="form-section">
                    ...
                    if (isset($_POST['save'])) 
                      {
                        ...
                        $db->update('exam_routine',['date'=>$date,'class_id'=>$class,'title'=>$title],"id='$id'");
                        ...
                        if($db)
                        {
                            ...
                            if($file)
                            {
                                ...
                                $path = '../../asset/img/exam_routine/'.$image_name;

                                move_uploaded_file($_FILES['image']['tmp_name'],$path);
                                $db->link->query("UPDATE `exam_routine` SET `image`='$image_name' WHERE `id`='$id'");
                        ...
                        $sql = $db->link->query("SELECT * FROM `exam_routine` WHERE `id`='$id'");
                    ...
                    <div class="form-body-main">
                        ...
                        <div class="form-group row">
                            ...
                            <img src="../../asset/img/exam_routine/<?php echo $showdata['image']; ?>" class="img-fluid" alt="" height="80px" width="80px">
                        </div>
