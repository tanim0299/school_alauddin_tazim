...
<!-- Start app main Content -->
        <div class="main-content">
            <section class="section">
                ...
                <div class="links">
                    <a href="view_magazine.php" class="btn btn-info">View Magazine</a>
                </div>
                <div class="form-section">
                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        if(isset($_POST['save']))
                        {
                                ...
                                $sql = $db->link->query("UPDATE `magazine` SET `date`='$date',`title`='$title' WHERE `id`='$id' ");
                                ...
                                if($sql)
                                {
                                    ...
                                    if($file)
                                    {
                                        ...
                                        $path = '../../asset/img/magazine/'.$image_name;

                                        move_uploaded_file($_FILES['image']['tmp_name'],$path);
                                        $db->link->query("UPDATE `magazine` SET `image`='$image_name' WHERE `id`='$id'");
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-body-main">
                            ...
                            <div class="form-group row">
                                ...
                                <img src="../../asset/img/magazine/<?php echo $showdata['image']; ?>" class="img-fluid" alt="" height="80px" width="80px">
                            </div>
