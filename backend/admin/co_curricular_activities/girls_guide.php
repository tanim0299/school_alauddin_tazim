            ...
            <section class="section">
                ...
                <div class="form-section">
                    ...
                    if(isset($_POST['save']))
                    {
                        ...
                        $sql_update = $db->link->query("UPDATE `girls_guide` SET `description`='$description' WHERE `id`=1");
                        if($sql_update)
                        {
                    ...
                    $sql_select = $db->link->query("SELECT * FROM `girls_guide` WHERE `id`=1");
                    if($sql_select)
                    {
