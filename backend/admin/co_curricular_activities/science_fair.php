        ...
        <div class="main-content">
            <section class="section">
                ...
                if(isset($_POST['save']))
                {
                    ...
                    $db->insert('science_fair',['date'=>$date,'title'=>$title, 'description'=>$description]);
                    ...
                    if($file)
                    {
                        ...
                        $image_path = '../../asset/img/science_fair/'.$image_name;

                        move_uploaded_file($_FILES['image']['tmp_name'],$image_path);

                        $db->update('science_fair',['image'=>$image_name],"id='$id'");
