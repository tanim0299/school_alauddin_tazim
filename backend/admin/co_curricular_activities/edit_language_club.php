                ...
                <div class="form-section">
                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        if(isset($_POST['save']))
                        {
                                ...
                                $sql = $db->link->query("UPDATE `language_club` SET `date`='$date',`title`='$title',`description`='$description' WHERE `id`='$id' ");
                                ...
                                if($sql)
                                {
                                    ...
                                    if($file)
                                    {
                                        ...
                                        $path = '../../asset/img/language_club/'.$image_name;

                                        move_uploaded_file($_FILES['image']['tmp_name'],$path);
                                        $db->link->query("UPDATE `language_club` SET `image`='$image_name' WHERE `id`='$id'");
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-body-main">
                            ...
                            <div class="input-single-box">
                                ...
                                <img src="../../asset/img/language_club/<?php echo $showdata['image']; ?>" class="img-fluid" alt="" height="80px" width="80px">
                            </div>
