        ...
        <div class="main-content">
            <section class="section">
                <div class="form-header">
                    <h4>Edit Cultural Activities</h4>
                </div>
                <div class="links">
                    <a href="view_cultural_activities.php" class="btn btn-info">View Cultural Activities</a>
                </div>
                <div class="form-section">
                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        if(isset($_POST['save']))
                        {
                                ...
                                $sql = $db->link->query("UPDATE `cultural_activities` SET `date`='$date',`title`='$title',`description`='$description' WHERE `id`='$id' ");
                                ...
                                if($sql)
                                {
                                    ...
                                    if($file)
                                    {
                                        ...
                                        $path = '../../asset/img/cultural_activities/'.$image_name;

                                        move_uploaded_file($_FILES['image']['tmp_name'],$path);
                                        $db->link->query("UPDATE `cultural_activities` SET `image`='$image_name' WHERE `id`='$id'");
                        ...
                        $sql = $db->link->query("SELECT * FROM `cultural_activities` WHERE `id`='$id'");
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-body-main">
                            ...
                            <div class="input-single-box">
                                ...
                                <img src="../../asset/img/cultural_activities/<?php echo $showdata['image']; ?>" class="img-fluid" alt="" height="80px" width="80px">
                            </div>
