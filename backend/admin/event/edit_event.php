...
<!-- Start app main Content -->
        <div class="main-content">
            <section class="section">
                ...
                <div class="links">
                    <a href="view_event.php" class="btn btn-info">View Event</a>
                </div>
                <div class="form-section">
                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        if(isset($_POST['save']))
                        {
                                ...
                                $sql = $db->link->query("UPDATE `event` SET `date`='$date',`title`='$title',`description`='$description' WHERE `id`='$id' ");
                                ...
                                if($sql)
                                {
                                    ...
                                    if($file)
                                    {
                                        ...
                                        $path = '../../asset/img/event/'.$image_name;

                                        move_uploaded_file($_FILES['image']['tmp_name'],$path);
                                        $db->link->query("UPDATE `event` SET `image`='$image_name' WHERE `id`='$id'");
                        ...
                        $sql = $db->link->query("SELECT * FROM `event` WHERE `id`='$id'");
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-body-main">
                            ...
                            <div class="input-single-box">
                                ...
                                <img src="../../asset/img/event/<?php echo $showdata['image']; ?>" class="img-fluid" alt="" height="80px" width="80px">
                            </div>
