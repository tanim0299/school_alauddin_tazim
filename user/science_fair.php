								...
								<div class="row">
									<div class="col-3">
										<div class="news-image">
											<img src="../backend/asset/img/science_fair/<?php print $showdata['image']; ?>" class="img-fluid" style="max-height: 300px;">
										</div>
									</div>
									<div class="col-8">
										<div class="heading">
											<a href="view_sciencefair.php?id=<?php echo $showdata['0']; ?>">
											<?php echo $showdata['2']; ?>
										</a>
										</div>
										<div class="pub-date">
