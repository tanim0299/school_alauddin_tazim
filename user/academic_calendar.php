						...
						<div class="data">
							<table class="table table-hover table-bordered" id="myTable">
								<thead>
									...
									<?php
									$sql = $db->link->query("SELECT * FROM `academic_calender` ORDER BY `date` DESC");
									if($sql)
									{
										$sl = 1;
								...
								<tbody>
									<tr style="font-size: 12px;">
										<td><a href="view_yearly_working_plan.php?id=<?php echo $showdata['0']; ?>" style="text-decoration: none;color: black"><?php echo $sl++; ?></a></td>
