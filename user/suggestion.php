						...
						<div class="data">
							<table class="table table-hover table-bordered" id="myTable">
								<thead>
									...
									<?php
									$sql = $db->link->query("SELECT * FROM `suggestion` ORDER BY `id` DESC");
									if($sql)
									{
										$sl = 1;
								...
								<tbody>
									<tr style="font-size: 12px;">
										<td><a href="view_suggestion.php?id=<?php echo $showdata['0']; ?>" style="text-decoration: none;color: black"><?php echo $sl++; ?></a></td>
